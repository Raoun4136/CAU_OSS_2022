...
function saveSnake()
{
    ...
    localStorage.setItem("saveData"+((i+save_x)%5),JSON.stringify({name : document.querySelector("#save_name input").value, Score : score, snakeArray : snake, apple : apple}));  //새로운 div 창에서 입력된 값 저장
    save_x++;
